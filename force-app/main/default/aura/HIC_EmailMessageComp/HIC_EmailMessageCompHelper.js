({
    ...
    getEmailTemplateHelper: function (component, event) {
        ...
        action.setCallback(this, function (response) {
            ...
            component.set("v.emailTemplateList", emailfolderVSTemplateList[1].emailtemplatelist);
            // var temp = {
            //     'emailTemplateId': '00X0o0000027RLW',
            //     'emailTemplatename': 'DIA - Dispatch instruction record approved'
            // }
